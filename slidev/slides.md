...
def agent_loop(messages: list):
    while True:
        # s15: drain lead inbox each turn
...
class MessageBus:
    ...
    def read_inbox(self, name) -> list:
        # read and clear .team/inbox/{name}.jsonl
```
...
task = {
    ...
    "worktree_state": "active",  # independent from status
}
...
class WorktreeManager:
    def create(self, name, task_id=None, base_ref="HEAD"):
        ...
        # write index.json and bind task
        ...
